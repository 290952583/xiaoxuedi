package xiaoxuedi.api;

import com.google.gson.GsonBuilder;
import com.google.gson.JsonDeserializer;
import xiaoxuedi.api.service.*;
import xiaoxuedi.entity.Mission;
import xiaoxuedi.model.Output;
import xiaoxuedi.model.address.AddInput;
import xiaoxuedi.model.address.DeleteInput;
import xiaoxuedi.model.address.ListOutput;
import xiaoxuedi.model.address.UpdateInput;
import xiaoxuedi.model.common.SendSmsInput;
import xiaoxuedi.model.mission.*;
...
public class ApiTests extends Assert
{
    ...
    public void testMission() throws Exception
    {
        ...
        // 添加
        xiaoxuedi.model.mission.AddInput addInput = new xiaoxuedi.model.mission.AddInput();
        ...
        // 查询
        Output<List<xiaoxuedi.model.mission.ListOutput>> listOutput =
        ...
        // 删除
        xiaoxuedi.model.mission.DeleteInput deleteInput = new xiaoxuedi.model.mission.DeleteInput();
        ...
        listOutput = service.myList(new Mission.Status[]{Mission.Status.WAIT}, 0).execute().body();
        assertEquals(listOutput.getCodeInfo(), Output.Code.OK);
        xiaoxuedi.model.mission.ListOutput mission = listOutput.getData().get(0);

        // 修改
        xiaoxuedi.model.mission.UpdateInput updateInput = new xiaoxuedi.model.mission.UpdateInput();
